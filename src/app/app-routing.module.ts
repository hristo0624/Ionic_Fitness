...
export const routes: Routes = [
  ...
  { path: 'take-assessment', loadChildren: './pages/take-assessment/take-assessment.module#TakeAssessmentPageModule' },
  { path: 'my-transphormers/:id/transphormer-workout', loadChildren: './pages/my-transphormers/transphormer-workout/transphormer-workout.module#TransphormerWorkoutPageModule' },
  { path: 'advisor-assessment-list', loadChildren: './pages/my-transphormers/assessment-list/assessment-list.module#AssessmentListPageModule' },
  { path: 'advisor-assessment-detail/:id', loadChildren: './pages/my-transphormers/assessment-detail/assessment-detail.module#AssessmentDetailPageModule' },
  { path: 'my-transphormers/:id/assessments', loadChildren: './pages/my-transphormers/assessments/assessments.module#AssessmentsPageModule' }
];
